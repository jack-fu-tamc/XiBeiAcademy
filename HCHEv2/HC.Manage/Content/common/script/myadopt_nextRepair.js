...
$(function () {
    ...
    $(document).on('click', '.CancelOrder', function () {
        ...
        $.ajax({
            url: "/manage/Order/CanceOrderInfoAdop",
            data: { rReturnID: returnid, rInfoID: infoID },
        type: 'GET',
        dataType: 'json',
    ...
    $(document).on('click', '.delOrder', function () {
        ...
        var infoID = $(this).attr("infoID");
        $.ajax({
            url: "/manage/Order/DelOrderInfoAdop",
            data: { RinfoID: infoID },
            type: 'GET',
            dataType: 'json',
            error: function (xhr, status) {
    ...
    $(document).on('click', '.relase_btn', function () {
        ...
        $.ajax({
            url: "/manage/Order/CheckAndDeliveryAdop",
            data: { ConsumptionCode: Consumpno, tradeno: tadeNo, mstID: mstid, rRturnID: orderNo },
            type: 'GET',
            dataType: 'json',
            error: function (xhr, status) {
                alert("消费验证出错");
