(function ($) {
    ...
    $t.window.prototype = {
        ...
        ajaxRequest: function (url, data) {
            var loadingIconTimeout = setTimeout(function () {
                ...
                $('.t-window-content', this.element).html("<img src='/Administration/Content/images/ajax_loader.gif'>");
            }, 100);
            //alert(url);
            $.ajax({
                type: 'GET',
    ...
    $.extend($t.window, {
        create: function () {
            ...
            /*
            <div class="t-widget t-window" id="addcontract-window" style="display:none">            <div class="t-window-titlebar t-header">&nbsp;<span class="t-window-title">中联网</span>            <div class="t-window-actions t-header">            <a class="t-link" href="">            <span class="t-icon t-close">Close</span>            </a>            </div>            </div>            <div class="t-window-content t-content" style="overflow:auto;width:700px">
            */
